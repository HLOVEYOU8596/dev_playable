	...
	_proto.kImgSwipe_i = function () {
		var t = new eui.Image();
		this.kImgSwipe = t;
		t.anchorOffsetX = 93.76;
		t.anchorOffsetY = 22.39;
		t.source = "";
		t.visible = false;
		t.x = 108;
		t.y = 230.39;
	...
	function PancakeSkin() {
		_super.call(this);
		this.skinParts = ["kImgPancake3","kImgPancake1","kImgPancake2","kImgPancake4"];
	...
	_proto._Group1_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.kImgPancake3_i(),this.kImgPancake1_i(),this.kImgPancake2_i(),this.kImgPancake4_i()];
		return t;
	};
