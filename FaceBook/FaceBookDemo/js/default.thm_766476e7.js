	...
	function GameMainDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kImgShape1","kImgBuild1","kGrpBuild1","kImgShape2","kImgBuild2","kGrpBuild2","kImgShape3","kImgBuild3","kGrpBuild3","kImgDeocrate","kGrpMap","kImgMenuBg","kImgGift","kBuild1","kBuild2","kBuild3","kGrpMenu","kGrpAction","kGrpGuide","kImgPlayfree","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kGrpMap_i(),this.kGrpMenu_i(),this.kGrpAction_i(),this.kGrpGuide_i(),this.kImgPlayfree_i()];
		return t;
	};
	_proto.kGrpMap_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.kImgBg_i(),this.kGrpBuild1_i(),this.kGrpBuild2_i(),this.kGrpBuild3_i(),this.kImgDeocrate_i()];
		return t;
	};
